...
print('Saving deviations...')
write.table(devTable, file = gzfile(file.path(input,"deviations.tsv.gz")), sep = "\t", quote = FALSE, row.names = TRUE, col.names=NA)
print('Saving zscores...')
write.table(zTable, file = gzfile(file.path(input,"zscores.tsv.gz")), sep = "\t", quote = FALSE, row.names = TRUE, col.names=NA)
